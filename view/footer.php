  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Reservados</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
        ...
        -->
        Diseñado por <a href="https://instagram.com/berno_r_?igshid=OGQ5ZDc2ODk2ZA==">Bernardo R.</a>
      </div>
    </div>
  </footer><!-- #footer -->
